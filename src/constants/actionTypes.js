...
export const BATCH_DOWNLOAD = "BATCH_DOWNLOAD";
export const BATCH_DOWNLOAD_PENDING = "BATCH_DOWNLOAD_PENDING";
export const BATCH_DOWNLOAD_FULFILLED = "BATCH_DOWNLOAD_FULFILLED";
export const BATCH_DOWNLOAD_REJECTED = "BATCH_DOWNLOAD_REJECTED";
